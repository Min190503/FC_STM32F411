...
{
	// doc truc tiep thanh ghi cua TIM5, nhanh khong co do tre
...
void delay_us(uint32_t us)
{
	...
	{
		// Chờ đợi (Blocking delay - chỉ dùng lúc khởi tạo, không dùng trong Super Loop bay)
	}
}
/* USER CODE END 0 */
